    ...
    pub async fn from_fs(root: Option<&str>, sk: Option<&str>) -> Result<Self, Error> {
        ...
        let seed_anrs = vec![
            SeedANR {
                ...
                ts: 1757522697,
                signature: vec![
                    175, 28, 180, 44, 241, 151, 35, 175, 168, 113, 195, 146, 5, 215,
                    131, 67, 222, 133, 110, 95, 129, 234, 189, 9, 115, 113, 64, 156, 197, 172, 0, 80, 198, 2, 224, 6, 176, 154, 254, 184,
                    46, 86, 99, 228, 106, 77, 205, 212, 13, 195, 156, 159, 14, 229, 111, 209, 214, 208, 15, 85, 248, 180, 203, 178,
                    229, 39, 75, 198, 238, 153, 152, 49, 143, 248, 77, 2, 206, 145, 121, 30, 248, 86, 157, 251, 166, 106, 254, 224,
                    154, 250, 84, 254, 142, 78, 141, 143,
                ],
                ip4: "72.9.144.110".to_string(),
                pk: vec![
                    169, 232, 30, 216, 200, 234, 174, 189, 141, 213, 58, 136, 157, 140, 90, 134, 18, 171, 115, 48, 39, 90, 93,
                    57, 4, 62, 149, 32, 14, 124, 27, 102, 240, 220, 0, 197, 48, 126, 134, 122, 85, 169, 173, 158, 122, 228, 185, 240,
                ],
            },
            SeedANR {
                version: "1.1.7".to_string(),
                ...
                ts: 1757525152,
                signature: vec![
                    173, 14, 211, 218, 3, 204, 123, 219, 82, 74, 176, 175, 175, 128,
                    154, 141, 79, 60, 64, 209, 248, 79, 225, 145, 229, 235, 231, 67, 250, 132,
                    65, 2, 25, 179, 14, 240, 164, 94, 238, 147, 239, 49, 192, 179, 69, 181, 150,
                    126, 22, 188, 126, 87, 6, 254, 103, 253, 139, 148, 74, 0, 220, 6, 118, 50,
                    110, 212, 199, 65, 186, 231, 105, 185, 234, 225, 21, 150, 48, 141, 100, 223,
                    229, 175, 235, 12, 125, 186, 206, 125, 121, 132, 26, 63, 187, 171, 234,
                    213,
                ],
                ip4: "167.235.169.185".to_string(),
                pk: vec![
                    176, 120, 75, 148, 69, 45, 127, 232, 195, 254, 164, 173, 136, 138, 157,
