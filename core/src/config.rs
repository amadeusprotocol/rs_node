    ...
    pub async fn from_fs(root: Option<&str>, sk: Option<&str>) -> Result<Self, Error> {
        ...
        let seed_anrs = vec![
            SeedANR {
                ...
                pk: vec![
                    132, 185, 113, 23, 39, 105, 32, 50, 15, 152, 225, 159, 234, 175, 23, 147, 240, 146, 208, 142, 210,
                    5, 165, 81, 9, 197, 142, 193, 112, 240, 37, 132, 227, 122, 162, 186, 180, 15, 107, 125, 160, 241,
                    124, 19, 94, 221, 94, 242, 14, 42, 32, 249, 165, 234, 61, 168, 57, 187, 224, 18, 194, 159, 79, 74,
                    210, 148, 141, 206, 55, 73, 97, 25, 25, 106, 113, 163, 206, 72, 74, 114, 64, 186, 126, 157, 192,
                    83, 67, 99, 249, 160, 48, 144, 182, 169, 138, 199,
                ],
            },
            SeedANR {
