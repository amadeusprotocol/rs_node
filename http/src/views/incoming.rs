...
pub fn page(incoming: &HashMap<String, u64>) -> String {
...
<head>
    ...
    <title>Amadeus Incoming Messages - Dashboard</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Protocol messages received by count</p>
...
fn rows(incoming: &HashMap<String, u64>) -> String {
    let mut v: Vec<(&String, &u64)> = incoming.iter().collect();
    ...
    if s.is_empty() {
        s = r#"<tr><td colspan="2" style="text-align: center; color: #8e8e93;">No incoming messages recorded</td></tr>"#.to_string();
    }
